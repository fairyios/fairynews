...
/// 我的关注Table Cell
final class MineGuanzhuTableCell: UITableViewCell {
     
    /// 第一行
    public lazy var firstLine: MineDefaultTableCellRowView = {
        let view = MineDefaultTableCellRowView(true, true)
        return view
    }()
    ...
    convenience init() {
        let identifier = String(describing: MineGuanzhuTableCell.self)
